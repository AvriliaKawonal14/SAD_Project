<?php 
    ...
    require 'functions/func_pemakaian.php';
    ...
    $sql = "SELECT count(*) AS jmlh FROM barang";
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Data Pemakaian</a>
                </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM pemakaian
                                                    INNER JOIN barang ON pemakaian.id_barang = barang.id ORDER BY pemakaian.id_pemakaian DESC";
                                        $res = mysqli_query($conn, $sql);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- <input name="tanggal" type="hidden"> -->
                    ...
                    <div class="form-group">
                        <label>Jumlah</label>
                        <input name="jumlah" type="text" class="form-control" placeholder="Jumlah Barang .." autocomplete="off">
                    </div>                                                                 
                </div>
